...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		closeText: 'ОК', // Display text for close link
		prevText: 'Предыдущий месяц', // Display text for previous month link
		nextText: 'Следующий месяц', // Display text for next month link
